  ...
  const renderRoutes = (routeList, activeIndex = 0) => {
    ...
    routeList.forEach((route, index) => {
      ...
      const polyline = L.polyline(points, {
        color: index === activeIndex ? C.accent : "rgba(60,60,67,0.45)",
        weight: index === activeIndex ? 6 : 4,
        opacity: index === activeIndex ? 0.95 : 0.8,
        lineCap: "round",
        lineJoin: "round",
      }).addTo(map);
  ...
  const handleSelectSuggestion = async (item) => {
    ...
    try {
      ...
      const normalizedRoutes = (data.routes || []).map((route, index) => ({
        ...
        polylineCoords: route.polylineCoords || (route.polyline ? decodePolyline(route.polyline) : []),
      }));
          ...
          {activeRoute && (
            <div style={styles.activeRouteCard}>
              ...
              <div style={styles.activeGrid}>
                ...
                <Info title="Custo" value={activeRoute.fuelCostText || formatMoneyBRL(activeRoute.fuelCost)} />
